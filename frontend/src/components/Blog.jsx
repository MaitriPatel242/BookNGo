...
export default function Blog(){
    ...
    return(
        <div>
            <section className="max-w-[1320px] mx-auto py-24 px-3 ">
                <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                        <div className="relative w-fit px-8 flex items-center justify-center">
                            <span className="bg-green rounded-md opacity-15 absolute w-full h-full z-10">
                                
                            </span>
                            <h6 className="text-green relative font-semibold"> Recent news feed</h6>
                            <h3 className="lg:text-5xl text-3xl font-bold pb-8 lg:w-2/3 py-4">Latest news and articles from the blog</h3>
                        </div>
                        <button className="lg:block hidden bg-green text-white rounded-lg text-lg shadow py-4 px-8 font-bold">View More</button>
                    </div>
                    <div>
                          <Blogs text="Things to see and do when visiting Japan" title="Adventure" image="/blog-01.jpg"/>
                          <Blogs text="A place where start new life with adventure travel" title="City Tours" image="/blog-02.jpg"/>
                          <div className='flex flex-col'>
            ...
            <div>
                <Carousel responsice={responsive} infinite autoPlay={true} itemClass='px-4'>
                   <div className='h-[298px] relative overflow-hidden'>
                        <img src="/tour-2.jpg" alt="" className='rounded-lg h-full object-cover hoverImg'/>
                   </div>
                   <div className='h-[298px] relative overflow-hidden'>
                        <img src="/tour-5.jpg" alt="" className='rounded-lg h-full object-cover hoverImg'/>
                   </div>
                   <div className='h-[298px] relative overflow-hidden'>
                        <img src="/tour-11.jpg" alt="" className='rounded-lg h-full object-cover hoverImg'/>
                   </div>
                   <div className='h-[298px] relative overflow-hidden'>
                        <img src="/tour-3.jpg" alt="" className='rounded-lg h-full object-cover hoverImg'/>
                   </div>
                   <div className='h-[298px] relative overflow-hidden'>
                        <img src="/tour-10.jpg" alt="" className='rounded-lg h-full object-cover hoverImg'/>
                   </div>
                </Carousel>
            </div>
        </div>
