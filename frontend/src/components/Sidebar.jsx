                    ...
                    <div className="w-full">
                        ...
                        <ReactSlider
                            ...
                            renderTrack={(props, state) => {
                                ...
                                const trackStyle = index === 1 ? { backgroundColor: "#F7921E" } : { backgroundColor: '#999' };
                                return (
                            ...
                            renderThumb={(props, state) => {
                                const { key, ...restProps } = props;
                                return(
                                    <div key={key} {...restProps} style={{ ...restProps.style, backgroundColor:"#F7921E", borderRadius: '50%', width: '20px', height: '20px' }} />
                                );
                            }}
                        />
                    </div>
